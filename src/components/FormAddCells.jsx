...
const FormAddCells = ({ addEntry }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        addEntry(name, lastName, day, contactNumber, email, temperature, internationalTravel, symptoms, soreThroat, cough, shortnesOfBreath);
        setId('');
        setName('');
        setLastName('');
        setDay('');
                ...
                <div >
                    <div className="row">
                        <div className="col">
                            ...
                            <input type="date" className="form-control w-50" placeholder="Enter Day" required onChange={(e) => setDay(e.target.value)} />
                        ...
                        <div className="col">
                            ...
                            <input type="text" className="form-control w-50" placeholder="Do you have any flulike symptoms?" required onChange={(e) => setSymptoms(e.target.valu)} />
                    ...
                    <button type="submit" className="btn btn-dark mt-5 mb-5 w-50 h-10">Submit</button>
